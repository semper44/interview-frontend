$(document).ready(function() {
    ...
    function createANewTableRow(item, element){
        ...
        console.log(dateDue);
        let td2 = $('<td>').addClass('px-6 py-4 hidden md:block whitespace-nowrap');
        ...
        let td3 = $('<td>').addClass('px-6 py-4  hidden md:block whitespace-nowrap ');
        ...
        let td4 = $('<td>').addClass('px-6  hidden md:block whitespace-nowrap');
